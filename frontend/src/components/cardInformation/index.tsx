...
export default function CardInformation({icon: Icon, title, description}:CardInformationProps){
    return (
        <Card className='w-70 h-full border shadow-pink-300 shadow-md border-gray-200'>
            <div className='flex justify-center items-center '>
                <div className='border rounded-xl w-12 h-12 flex justify-center items-center bg-linear-to-br from-pink-500 to-purple-500'>
